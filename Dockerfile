...
RUN pip install torch torchvision torchaudio --extra-index-url https://download.pytorch.org/whl/cu128 && \
    ...
    pip install lightning transformers==4.53.2 moviepy==1.0.3 k-diffusion open-clip-torch omegaconf blobfile tiktoken sentencepiece==0.2.0 descript-audio-codec vector-quantize-pytorch protobuf==5.29.5 runpod && \
